...
unsigned long rule = N*3;                                   // reward rules
...
// variables for changing modules
...
void give_cue(){
  cue_state = true;
  Cue_time = millis();
  t.pulseImmediate(out_cue,1000,HIGH);               // use Timer to turn on reward for specific period
}

void give_punish(){
  t.pulseImmediate(out_punish,1000,HIGH);           // use Timer to turn on reward for specific period
}
...
//          hijack_click();                                  // as a indicator for test

//  Serial.println(' ');
//  Serial.print('\t');
//  Serial.println(slowTime);
//  Serial.println(Cue_time);
//  Serial.println(counter);
//  Serial.println(Diff);  
//  Serial.print('\t');
//  Serial.println(outputV);
//  Serial.print('\t');
//  Serial.println(reward_state);
//  Serial.print('\t');
//  Serial.println(slowTime);
//  Serial.print('\t');
//  Serial.println(count_reward);


//// read the analog in value:
//  sensorValue = analogRead(analogInPin);
//  // map it to the range of the analog out:
//  outputValue = map(sensorValue, 0, 1023, 0, 4);
